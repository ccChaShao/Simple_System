...
namespace TMPro.EditorUtilities
{
    public abstract class TMP_BaseEditorPanel : Editor
    {
        ...
        protected SerializedProperty m_i18nKey;
        ...
        protected virtual void OnEnable()
        {
            ...
            m_i18nKey = serializedObject.FindProperty("m_i18nKey");
        ...
        public void OnSceneGUI()
        {
            ...
            var fmh_342_63_639037647467644417 = Quaternion.identity; Vector3 newLeft = Handles.FreeMoveHandle(oldLeft, HandleUtility.GetHandleSize(m_RectTransform.position) * 0.05f, Vector3.zero, Handles.DotHandleCap);
            ...
            var fmh_357_61_639037647467666621 = Quaternion.identity; Vector3 newTop = Handles.FreeMoveHandle(oldTop, HandleUtility.GetHandleSize(m_RectTransform.position) * 0.05f, Vector3.zero, Handles.DotHandleCap);
            if (oldTop != newTop)
            {
            ...
            var fmh_371_65_639037647467670158 = Quaternion.identity; Vector3 newRight = Handles.FreeMoveHandle(oldRight, HandleUtility.GetHandleSize(m_RectTransform.position) * 0.05f, Vector3.zero, Handles.DotHandleCap);
            ...
            var fmh_385_67_639037647467673146 = Quaternion.identity; Vector3 newBottom = Handles.FreeMoveHandle(oldBottom, HandleUtility.GetHandleSize(m_RectTransform.position) * 0.05f, Vector3.zero, Handles.DotHandleCap);
        ...
        protected void DrawI18nText()
        {
            ...
            {
                m_i18nKey.stringValue = newVal;
                m_TextProp.stringValue = TMP_Text.i18nGetFunc?.Invoke(newVal);
            }

            // new text
            if (string.IsNullOrEmpty(m_i18nKey.stringValue))
            {
                return;
            }
